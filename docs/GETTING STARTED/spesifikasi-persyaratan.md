...
1. Billing Manager menggunakan protokol API modern yang dioptimalkan untuk Mikrotik RouterOS versi 7 (v7.x), Mikrotik RouterOS versi 6 bisa, akan tetapi yang paling diutamakan pengembangan versi terbaru.&#x20;
